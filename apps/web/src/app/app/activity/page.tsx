...
export default async function ActivityPage({ searchParams }: Props) {
  ...
  return (
    <>
      <PageHeader index="10 — Activity" title="Timeline" description="Everything that happened in this workspace, newest first: what you saved, traded, believed and asked, and what JARVIS noticed." />
