...
export default async function WatchlistPage() {
  ...
  return (
    <>
      <PageHeader index="09 — Watchlist" title="Watchlist" description="Assets you are watching and what you are watching them for, with how often they come up in your memory and the theses that depend on them." />
